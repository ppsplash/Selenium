...
public class SeleniumLocators {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("inputUsername")).sendKeys("Anitha");
		driver.findElement(By.name("inputPassword")).sendKeys("Anitha@123");
		driver.findElement(By.className("signInBtn")).click();
		System.out.println(driver.findElement(By.cssSelector("p.error")).getText());
		driver.findElement(By.linkText("Forgot your password?")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("//input[@placeholder='Name']")).sendKeys("Anitha");
		driver.findElement(By.cssSelector("input[placeholder='Email']")).sendKeys("Anitha@rsa.com");
		...
		driver.findElement(By.xpath("//form/input[3]")).sendKeys("9842759444");
		driver.findElement(By.cssSelector(".reset-pwd-btn")).click();
		System.out.println(driver.findElement(By.cssSelector("form p")).getText());
		driver.findElement(By.xpath("//div[@class='forgot-pwd-btn-conainer']/button[1]")).click();
		Thread.sleep(1000);	
		driver.findElement(By.cssSelector("#inputUsername")).sendKeys("Anitha");
